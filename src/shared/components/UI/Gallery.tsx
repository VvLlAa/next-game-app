  ...
  return (
    <div className={styles['gallery']}>
      ...
      <div className={styles['gallery__wrapper']}>
        ...
        <div
          className={styles['gallery__thumbnails-container']}
          ref={containerRef}
        >
          {screenshots.map((image, index) => (
            <Image
              ...
              style={{
                border:
                  index === selectedImage
                    ? '2px solid var(--text-color-purple)'
                    : '2px',
              }}
        ...
        <>
          <div className={styles['gallery__fullscreen-overlay']}>
            <div className={styles['gallery__fullscreen-content']}>
              <button
                className={styles['gallery__fullscreen-close']}
            ...
            <div className={styles['gallery__fullscreen-controls']}>
              <button
                className={styles['gallery__fullscreen-prev']}
                onClick={goToPrevious}
              >
                Назад
              </button>
              <button
                className={styles['gallery__fullscreen-next']}
                onClick={goToNext}
              >
                Вперед
              </button>
